 ...
 * [radsav.yml](radsav.yml)
     * Determines how your purl.obolibrary.org/obo/radsav/ redirects will be handled
     ...
     * Paste in the contents of [radsav.yml](radsav.yml)
 ...
 * [radsav.md](radsav.md)
     ...
     * Paste in the contents of [radsav.md](radsav.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
