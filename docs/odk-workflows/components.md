...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/radsav-odk.yaml)
...
6) In your custom makefile (src/ontology/radsav.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
