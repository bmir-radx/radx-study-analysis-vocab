...
1. Add an import statement to your `src/ontology/radsav-edit.owl` file. We suggest to do this using a text editor, by simply copying an existing import declaration and renaming it to the new ontology import, for example as follows:
    ```
    ...
    Ontology(<https://github.com/bmir-radx/radsav.owl>
    Import(<https://github.com/bmir-radx/radsav/imports/ro_import.owl>)
    Import(<https://github.com/bmir-radx/radsav/imports/go_import.owl>)
    ...
    ```
...
```
<uri name="https://github.com/bmir-radx/radsav/imports/go_import.owl" uri="imports/go_import.owl"/>
```
