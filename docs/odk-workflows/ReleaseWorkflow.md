...
1. Go to your releases page on GitHub by navigating to your repository, and then clicking on releases (usually on the right, for example: https://github.com/bmir-radx/radx-study-analysis-vocab/releases). Then click "Draft new release"
